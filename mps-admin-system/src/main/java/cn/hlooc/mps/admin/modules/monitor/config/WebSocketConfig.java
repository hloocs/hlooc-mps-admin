package cn.hlooc.mps.admin.modules.monitor.config;

import cn.hlooc.mps.admin.modules.monitor.domain.LogMessage;
import cn.hlooc.mps.admin.modules.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(log!=null){
                            // 格式化异常堆栈信息
                            if("ERROR".equals(log.getLevel()) && "cn.hlooc.mps.admin.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())){
