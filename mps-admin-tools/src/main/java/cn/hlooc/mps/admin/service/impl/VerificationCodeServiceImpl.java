...
import cn.hlooc.mps.admin.repository.VerificationCodeRepository;
...
import cn.hlooc.mps.admin.exception.BadRequestException;
import cn.hlooc.mps.admin.repository.VerificationCodeRepository;
import cn.hlooc.mps.admin.service.VerificationCodeService;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    private static final String DESC = "后台管理系统";
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if (verificationCode == null) {
            ...
            emailVo = new EmailVo(Arrays.asList(code.getValue()), DESC, content);
            ...
            emailVo = new EmailVo(Arrays.asList(verificationCode.getValue()), DESC, content);
        }
        return emailVo;
    }
